...
The [ACVS pipeline](https://github.com/PennSIVE/PennSIVE_neuro_pip/tree/main/pipelines/cvs) (Automated Central Vein Sign) integrates an automated technique for the detection of the central vein sign in white matter lesions, developed by Dr. Jordan Dworkin. It provides processed T1-weighted, T2-FLAIR, and T2star-magnitude images, as well as subject-level CVS probabilities.
